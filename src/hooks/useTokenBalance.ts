...
export const useBnbPrice = () => {
    ...
    const fetchBalance = useCallback(async () => {
      const busd = await getBalance(ethereum, '0xe9e7cea3dedca5984780bafc599bd69add087d56', '0x1B96B92314C44b159149f7E0303511fB2Fc4774f')
      const bnb = await getBalance(ethereum, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', '0x1B96B92314C44b159149f7E0303511fB2Fc4774f')
